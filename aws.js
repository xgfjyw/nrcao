...
module.exports = function(RED) {
    ...
    // function AmazonS3createBucketNode(n) {
    //     RED.nodes.createNode(this,n);
    //     this.awsConfig = RED.nodes.getNode(n.aws);
    //     this.region = n.region  || "s3.cn-east-2.jdcloud-oss.com";
    //     this.bucket = n.bucket;
    ...
    //         var s3 = new AWS.S3({"endpoint": node.region});
    //         node.on("input", function(msg) {
    //             node.status({fill:"blue",shape:"dot",text:"aws.status.createing-bucket"});
    //             var bucket = node.bucket || msg.bucket;
    ...
    //     }
    // }
    // RED.nodes.registerType("jdcloud c_bucket",AmazonS3createBucketNode);
};
